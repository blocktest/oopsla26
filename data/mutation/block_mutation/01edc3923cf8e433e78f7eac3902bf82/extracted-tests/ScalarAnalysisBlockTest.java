...
public class ScalarAnalysisBlockTest {
    ...
    public void testLine184() throws Exception {
        ...
        boolean[] _blocktest_flow_testLine184 = new boolean[0];
        if (spaces && breaks)
        ...
        for (int _blocktest_testLine184_i = 0; _blocktest_testLine184_i < 0; _blocktest_testLine184_i += 1) {
            assertTrue(_blocktest_flow_testLine184[_blocktest_testLine184_i]);
        }
    }
}
