...
public class JsonSanitizerBlockTest {
    ...
    @Test
    public void testLine372() throws Exception {
        int end = 0;
    ...
    @Test
    public void testLine374() throws Exception {
        int end = 0;
    ...
    @Test
    public void testLine376() throws Exception {
        int end = 0;
        String jsonish = "/*";
        int i = 0;
        int n = jsonish.length();
    ...
    @Test
    public void testLine378() throws Exception {
        int end = 0;
