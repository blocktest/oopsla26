   ...
   public static FieldType getInstance(ProjectFile project, int value)
   {
      ...
      if ((value & 0x8000) != 0)
      {
         return project.getUserDefinedFields().getOrCreateAssignmentField(Integer.valueOf(value), (k) -> {
            // BLOCKTEST EVAL: https://github.com/joniles/mpxj/blob/91540932b1db27a525f1ee9e9fb9d878acedfc74/src/main/java/net/sf/mpxj/common/MPPAssignmentField.java#L55-L60
            ...
            blocktest().given(k, Integer.valueOf(10)).checkEq(( (UserDefinedField) methodReturn).getFieldTypeClass(), FieldTypeClass.ASSIGNMENT);
