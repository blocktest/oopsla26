...
public class GitLabApiV3Wrapper implements IGitLabApiWrapper {
    ...
    public String getRevisionForLine(File file,String path, int lineNumber) {
        ...
        for (String revision : config.commitSHA()) {
            ...
            // BLOCKTEST EVAL: https://github.com/gabrie-allaigre/sonar-gitlab-plugin/blob/1a6b20737c0e034fed35f555442fa493c6268e9f/src/main/java/com/talanlabs/sonar/plugins/gitlab/GitLabApiV3Wrapper.java#L251-L252
