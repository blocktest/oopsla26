            ...
            case 10: /* NTLM */
                ...
                if ( !anonymous && isSignatureSetupRequired() ) {
                    if ( isExternalAuth(getContext(), npa) ) {
                        ...
                        // BLOCKTEST EVAL: https://github.com/codelibs/jcifs/blob/c9ad4eeaf763ad764cb485c4149a0b236eaa7d3e/src/main/java/jcifs/smb/SmbSessionImpl.java#L898C1-L902C85
                        blocktest().given(npa, new NtlmPasswordAuthenticator()).mock("getContext()", new jcifs.context.BaseContext(new jcifs.config.BaseConfiguration(true)))
                                .given(negoResp.getServerData().encryptionKey, new byte[]{'a', 'b'}, "byte[]").end(FIRST_THROW);
