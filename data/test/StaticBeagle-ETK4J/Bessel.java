        ...
        for (int i = 0; i < n; ++i) {
            SolverResults<Complex> sr = new NewtonRaphsonComplex(
                    z -> {
                        ...
                        blocktest().given(z, new Complex(5, 10)).given(n, 10).checkEq(methodReturn.toString(), "(45532726963875710000.0000 - 74323182754758330000.0000j)");
                        blocktest().given(z, new Complex(2, 0)).given(n, 0).checkEq(methodReturn.toString(), "(1.7725 + 0.0000j)");
