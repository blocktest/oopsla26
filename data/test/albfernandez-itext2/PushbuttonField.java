...
public class PushbuttonField extends BaseField {
    ...
    public PdfAppearance getAppearance() throws IOException, DocumentException {
        ...
        if (haveIcon) {
            ...
            if (proportionalIcon) {
                // BLOCKTEST EVAL: https://github.com/albfernandez/itext2/blob/5ac684e2140a3d9a5b4c34dfd2639dcc87884ad0/src/main/java/com/lowagie/text/pdf/PushbuttonField.java#L476C1-L492C27
                blocktest().given(scaleIcon, 3).given(icx, 10).given(icy, 5).checkEq(icx, 1, 0.01).checkEq(icy, 1, 0.01);
                blocktest().given(scaleIcon, 3).given(icx, 10).given(icy, 15).checkEq(icx, 1, 0.01).checkEq(icy, 1, 0.01);
                blocktest().given(scaleIcon, 3).given(icx, 0).given(icy, 5).checkEq(icx, 0, 0.01).checkEq(icy, 0, 0.01);
                blocktest().given(scaleIcon, 4).given(icx, 10).given(icy, 5).checkEq(icx, 5, 0.01).checkEq(icy, 5, 0.01);
                blocktest().given(scaleIcon, 4).given(icx, 0).given(icy, 5).checkEq(icx, 1, 0.01).checkEq(icy, 1, 0.01);
                blocktest().given(scaleIcon, 2).given(icx, 0).given(icy, 5).checkEq(icx, 1, 0.01).checkEq(icy, 1, 0.01);
                blocktest().given(scaleIcon, 9).given(icx, 100).given(icy, 105).checkEq(icx, 100, 0.01).checkEq(icy, 100, 0.01);
                blocktest().given(scaleIcon, 9).given(icx, 100).given(icy, 95).checkEq(icx, 95, 0.01).checkEq(icy, 95, 0.01);
                switch (scaleIcon) {
