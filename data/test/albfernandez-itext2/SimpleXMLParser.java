    ...
    private void go(Reader r) throws IOException {
        ...
        while(true) {
			...
			case ENTITY:
                if(character == ';') {
                    state = restoreState();
                    // BLOCKTEST EVAL: https://github.com/albfernandez/itext2/blob/5ac684e2140a3d9a5b4c34dfd2639dcc87884ad0/src/main/java/com/lowagie/text/xml/simpleparser/SimpleXMLParser.java#L376C2-L383C38
                    blocktest().given(state, 0).given(entity , new StringBuilder().append("#x400")).given(text, new StringBuilder())
                            .checkEq(text.toString(), "Ѐ").checkTrue(entity.toString().isEmpty());
                    blocktest().given(state, 0).given(entity , new StringBuilder().append("#100")).given(text, new StringBuilder())
                            .checkEq(text.toString(), "d").checkTrue(entity.toString().isEmpty());
                    blocktest().given(state, 0).given(entity , new StringBuilder().append("nbsp")).given(text, new StringBuilder())
                            .checkEq(text.toString(), "" + '\u00a0').checkTrue(entity.toString().isEmpty());
                    blocktest().given(state, 0).given(entity , new StringBuilder().append("#x-853749375934987595")).given(text, new StringBuilder())
                            .checkEq(text.toString(), "&#x-853749375934987595;").checkTrue(entity.toString().isEmpty());
                    blocktest().given(state, 0).given(entity , new StringBuilder().append("#abc")).given(text, new StringBuilder())
                            .checkEq(text.toString(), "&#abc;").checkTrue(entity.toString().isEmpty());
                    blocktest().given(state, 0).given(entity , new StringBuilder().append("lol")).given(text, new StringBuilder())
                            .checkEq(text.toString(), "&lol;").checkTrue(entity.toString().isEmpty());
