...
public class SAXiTextHandler extends DefaultHandler {
    ...
    public void handleStartingTags(String name, final Properties attributes) {
        ...
        if (isDocumentRoot(name)) {
            ...
            for (Iterator i = attributes.keySet().iterator(); i.hasNext();) {
                // BLOCKTEST EVAL: https://github.com/albfernandez/itext2/blob/5ac684e2140a3d9a5b4c34dfd2639dcc87884ad0/src/main/java/com/lowagie/text/xml/SAXiTextHandler.java#L460C1-L473C20
                blocktest().given(leftMargin, 36).given(topMargin, 36).given(rightMargin, 36).given(bottomMargin, 36).given(i, new ArrayList<>(Arrays.asList("left")).iterator()).given(attributes, new Properties()).setup("attributes.setProperty(\"left\", \"1.25\");").end(FIRST_BLOCK).checkEq(leftMargin, 1.25, 0.001).checkEq(rightMargin, 36, 0.001).checkEq(topMargin, 36, 0.001).checkEq(bottomMargin, 36, 0.001);
                blocktest().given(leftMargin, 36).given(topMargin, 36).given(rightMargin, 36).given(bottomMargin, 36).given(i, new ArrayList<>(Arrays.asList("right")).iterator()).given(attributes, new Properties()).setup("attributes.setProperty(\"right\", \"1.25\");").end(FIRST_BLOCK).checkEq(leftMargin, 36, 0.001).checkEq(rightMargin, 1.25, 0.001).checkEq(topMargin, 36, 0.001).checkEq(bottomMargin, 36, 0.001);
                blocktest().given(leftMargin, 36).given(topMargin, 36).given(rightMargin, 36).given(bottomMargin, 36).given(i, new ArrayList<>(Arrays.asList("top")).iterator()).given(attributes, new Properties()).setup("attributes.setProperty(\"top\", \"1.25\");").end(FIRST_BLOCK).checkEq(leftMargin, 36, 0.001).checkEq(rightMargin, 36, 0.001).checkEq(topMargin, 1.25, 0.001).checkEq(bottomMargin, 36, 0.001);
                blocktest().given(leftMargin, 36).given(topMargin, 36).given(rightMargin, 36).given(bottomMargin, 36).given(i, new ArrayList<>(Arrays.asList("bottom")).iterator()).given(attributes, new Properties()).setup("attributes.setProperty(\"bottom\", \"1.25\");").end(FIRST_BLOCK).checkEq(leftMargin, 36, 0.001).checkEq(rightMargin, 36, 0.001).checkEq(topMargin, 36, 0.001).checkEq(bottomMargin, 1.25, 0.001);
                blocktest().given(leftMargin, 36).given(topMargin, 36).given(rightMargin, 36).given(bottomMargin, 36).given(i, new ArrayList<>(Arrays.asList("bye")).iterator()).given(attributes, new Properties()).setup("attributes.setProperty(\"top\", \"foo\");").checkEq(leftMargin, 36, 0.001).checkEq(rightMargin, 36, 0.001).checkEq(topMargin, 36, 0.001).checkEq(bottomMargin, 36, 0.001);
                blocktest().given(leftMargin, 36).given(topMargin, 36).given(rightMargin, 36).given(bottomMargin, 36).given(i, new ArrayList<>(Arrays.asList("bottom")).iterator()).given(attributes, new Properties()).setup("attributes.setProperty(\"top\", \"foo\");").end(FIRST_BLOCK).expect(ExceptionConverter.class);
                key = (String) i.next();
