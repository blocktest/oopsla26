...
public class timeZone {
    public static String timeZoneByCountryAndRegion(String country, String region) {
        ...
        if ("AD".equals(country)) {
            ...
            // BLOCKTEST EVAL: https://github.com/maxmind/geoip-api-java/blob/0ed8a38981512667533d47204486aae0278a1bc8/src/main/java/com/maxmind/geoip/timeZone.java#L33-L81
            blocktest().given(timezone, null).given(region, "01").checkEq(timezone, "America/Argentina/Buenos_Aires");
            blocktest().given(timezone, null).given(region, "02").checkEq(timezone, "America/Argentina/Catamarca");
            blocktest().given(timezone, null).given(region, "03").checkEq(timezone, "America/Argentina/Tucuman");
            blocktest().given(timezone, null).given(region, "04").checkEq(timezone, "America/Argentina/Rio_Gallegos");
            blocktest().given(timezone, null).given(region, "05").checkEq(timezone, "America/Argentina/Cordoba");
            blocktest().given(timezone, null).given(region, "06").checkEq(timezone, "America/Argentina/Tucuman");
            blocktest().given(timezone, null).given(region, "07").checkEq(timezone, "America/Argentina/Buenos_Aires");
            blocktest().given(timezone, null).given(region, "08").checkEq(timezone, "America/Argentina/Buenos_Aires");
            blocktest().given(timezone, null).given(region, "09").checkEq(timezone, "America/Argentina/Tucuman");
            blocktest().given(timezone, null).given(region, "10").checkEq(timezone, "America/Argentina/Jujuy");
            blocktest().given(timezone, null).given(region, "11").checkEq(timezone, "America/Argentina/San_Luis");
            blocktest().given(timezone, null).given(region, "12").checkEq(timezone, "America/Argentina/La_Rioja");
            blocktest().given(timezone, null).given(region, "13").checkEq(timezone, "America/Argentina/Mendoza");
            blocktest().given(timezone, null).given(region, "14").checkEq(timezone, "America/Argentina/Buenos_Aires");
            blocktest().given(timezone, null).given(region, "15").checkEq(timezone, "America/Argentina/San_Luis");
            blocktest().given(timezone, null).given(region, "16").checkEq(timezone, "America/Argentina/Buenos_Aires");
            blocktest().given(timezone, null).given(region, "17").checkEq(timezone, "America/Argentina/Salta");
            blocktest().given(timezone, null).given(region, "18").checkEq(timezone, "America/Argentina/San_Juan");
            blocktest().given(timezone, null).given(region, "19").checkEq(timezone, "America/Argentina/San_Luis");
            blocktest().given(timezone, null).given(region, "20").checkEq(timezone, "America/Argentina/Rio_Gallegos");
            blocktest().given(timezone, null).given(region, "21").checkEq(timezone, "America/Argentina/Buenos_Aires");
            blocktest().given(timezone, null).given(region, "22").checkEq(timezone, "America/Argentina/Catamarca");
            blocktest().given(timezone, null).given(region, "23").checkEq(timezone, "America/Argentina/Ushuaia");
            blocktest().given(timezone, null).given(region, "24").checkEq(timezone, "America/Argentina/Tucuman");
