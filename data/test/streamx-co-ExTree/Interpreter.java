    ...
    public Function<Object[], ?> visit(UnaryExpression e) {
        ...
        case ExpressionType.Convert:
            ...
            if (to.isPrimitive() || Number.class.isAssignableFrom(to))
                return t -> {
                // BLOCKTEST EVAL: https://github.com/streamx-co/ExTree/blob/2cb6b78c0eb4dc25fa81f582641b5464779a93fa/src/main/java/co/streamx/fluent/extree/expression/Interpreter.java#L382-L421
                    blocktest().given(t, null, "Object").given(first, null, "Object").mock("first.apply(t)", (Number) Integer.valueOf("5")).given(to, Integer.TYPE)
                            .checkReturnEq(5);
                    blocktest().given(t, null, "Object").given(first, null, "Object").mock("first.apply(t)", Long.valueOf("5")).given(to, Long.TYPE)
                            .checkReturnEq(5, 0.001);
                    blocktest().given(t, null, "Object").given(first, null, "Object").mock("first.apply(t)", Float.valueOf("5")).given(to, Float.TYPE)
                            .checkReturnEq(5, 0.001);
                    blocktest().given(t, null, "Object").given(first, null, "Object").mock("first.apply(t)", Double.valueOf("5")).given(to, Double.TYPE)
                            .checkReturnEq(5, 0.001);
