        ...
        while (!queue.isEmpty()) {
            ...
            if (value instanceof Number) {
                ...
                ((Map) value).forEach((nestedKey, nestedValue) -> {
                    ...
                    blocktest().given(key, "foo", "String").given(nestedKey, "bar", "String")
                            .given(individualMetrics, new ArrayList<>()).given(queue, new LinkedList<>()).given(nestedValue, new Object(), "Object");
