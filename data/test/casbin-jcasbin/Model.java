    ...
    public void sortPoliciesBySubjectHieraichy() {
        ...
        for (Map.Entry<String, Assertion> entry : model.get("p").entrySet()) {
            ...
            Collections.sort(assertion.policy, (o1, o2)->{
                ...
                blocktest().given(subjectHierarchyMap, new HashMap<String, Integer>(){{put("foo", 5); put("bar", 10);}}).given(o1, new ArrayList<String>(Arrays.asList("1", "2"))).given(o2, new ArrayList<String>(Arrays.asList("1", "2"))).given(domainIndex, -1).given(defaultDomain, "foo").mock("getNameWithDomain(domain1, o1.get(0))", "foo").mock("getNameWithDomain(domain2, o2.get(0))", "bar").checkReturnEq(5);
