  ...
  protected void sizeChanged() {
    if (ivOpened && !ivPending) {
      ...
      SwingUtilities.invokeLater(() -> {
          // BLOCKTEST EVAL: https://github.com/Blazemeter/xtn5250/blob/240e00411e0c21995e87f5a36dd0f6fee2929af8/src/main/java/net/infordata/em/crt5250/XI5250CrtFrame.java#L157-L166
          blocktest().given(ivFirstTime, true).given(ivSizeControlledFrame, false).mock("pack()").checkFalse(ivFirstTime).checkFalse(ivSizeControlledFrame).checkFalse(ivPending);
          blocktest().given(ivFirstTime, false).given(ivSizeControlledFrame, true).mock("pack()").checkFalse(ivFirstTime).checkTrue(ivSizeControlledFrame).checkFalse(ivPending);
          blocktest().given(ivFirstTime, true).given(ivSizeControlledFrame, true).mock("pack()").checkFalse(ivFirstTime).checkTrue(ivSizeControlledFrame).checkFalse(ivPending);
          blocktest().given(ivFirstTime, false).given(ivSizeControlledFrame, false).mock("pack()").checkFalse(ivFirstTime).checkFalse(ivSizeControlledFrame).checkFalse(ivPending);
