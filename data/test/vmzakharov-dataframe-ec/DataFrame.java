                    ...
                    if (joinType.isOuterJoin())
                    {
                        ...
                        joinColumnIndices.forEachWithIndex(
                            (joinColumnIndex, sourceKeyIndex) -> {
                                // BLOCKTEST EVAL: https://github.com/vmzakharov/dataframe-ec/blob/b5cef516c1f02207399f751ba922f9e5347f8f3c/src/main/java/io/github/vmzakharov/ecdataframe/dataframe/DataFrame.java#L1780-L1782
//                                blocktest().given(rowData, new Object[1]).given(joinColumnIndex, 0).given(sourceKeyIndex, 0).given(otherSortedIndex, 0)
//                                        .given(otherJoinColumns, new ListIterable<DfColumn>());
