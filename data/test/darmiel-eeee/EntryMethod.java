                ...
                for (final Parameter parameter : this.method.getParameters()) {
                    if (Call.class.isAssignableFrom(parameter.getType())) {
                        ...
                        parameters.add((Call<Object>) () -> {
                            // BLOCKTEST EVAL: https://github.com/darmiel/eeee/blob/f4114a3bf831ae88f6cca606f4d0f93ac09cc210/src/main/java/io/d2a/eeee/EntryMethod.java#L57-L64
                            blocktest().given(epc, new EntryPointCollection(new Scanner(System.in), new Injector(), new ArrayList<>()))
                                    .given(targetMethod, new EntryMethod(String.class.getMethods()[0], String.class.getMethods()[0].getAnnotation(Entrypoint.class), String.class)).checkTrue(methodReturn == null);
                            try {
