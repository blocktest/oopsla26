    ...
    public CompletableFuture<Void> closeAsync() {
        ...
        if (CLOSED.compareAndSet(this, ST_OPEN, ST_CLOSED)) {
            ...
            future.whenComplete((v, t) -> {
                // BLOCKTEST EVAL: https://github.com/lettuce-io/lettuce-core/blob/761d60247159662ce1db8bc20318bc4b573bc010/src/main/java/io/lettuce/core/RedisChannelHandler.java#L181-L191
                blocktest().mock("closeEvents.fireEventClosed(this)")
                    .given(closeFuture, new CompletableFuture<>())
                    .given(t, new Throwable()).given(v, null)
                    .checkTrue(closeFuture.isCompletedExceptionally());
                blocktest().mock("closeEvents.fireEventClosed(this)")
                    .given(closeFuture, new CompletableFuture<>())
                    .given(t, null).given(v, null)
                    .checkFalse(closeFuture.isCompletedExceptionally());
