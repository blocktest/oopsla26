    ...
    public void appendTo(StringBuilder _queryBuilder) {
        ...
        if (!this.customFilters.isEmpty()) {
            for (Map.Entry<String, Input<Serializable>> entry : customFilters.entrySet()) {
                ...
                if (filter != null) {
                    // BLOCKTEST EVAL: https://github.com/adobe/commerce-cif-magento-graphql/blob/0bc22bb767a8270f94ee04d85ab2571569a146a1/src/main/java/com/adobe/cq/commerce/magento/graphql/ProductFilterInput.java#L1411C1-L1416C22
                    blocktest().given(_queryBuilder, new StringBuilder()).given(filter, new ProductFilterInput())
                        .checkEq(_queryBuilder.toString(), "{}");
                    blocktest().given(_queryBuilder, new StringBuilder()).given(filter, new String("foo"))
                        .checkEq(_queryBuilder.toString(), "null");
                    try {
