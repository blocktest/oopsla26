...
public class AbstractParser implements Parser, Serializable {
  ...
  protected ASTNode nextToken() {
    try {
      ...
      Mainloop:
      while (cursor != end) {
        // BLOCKTEST EVAL: https://github.com/mvel/mvel/blob/236d37bc78a158553592afedbbf1aa27815efb78/src/main/java/org/mvel2/compiler/AbstractParser.java#L324-L329
        blocktest().given(expr, new char[]{'a', 'b', 'z', '/', '@'})
          .given(cursor, 0)
          .given(end, 5)
          .checkEq(cursor, 3)
          .end(FIRST_BLOCK);
