// BLOCKTEST EXAMPLE: https://github.com/srikanth-lingala/zip4j/blob/c4c993cb143db99832eadd03699bd8228a9793b8/src/main/java/net/lingala/zip4j/util/FileUtils.java#L225C10-L229C12
  ...
  public static String getRelativeFileName(File fileToAdd, ZipParameters zipParameters) throws ZipException {
    ...
    try {
      ...
      if (isStringNotNullAndNotEmpty(zipParameters.getDefaultFolderPath())) {
        ...
        String tmpFileName = ""; // Need to add this to avoid complain
        ...
        if (isSymbolicLink(fileToAdd)) {
          ...
          blocktest().given(fileToAdd, new File("/my/abc/def/../ghi/")).given(fileCanonicalPath, "/my/abc/def/ghi/").given(rootFolderFileRef, "/my/abc/").checkEq(tmpFileName, "def/ghi/");
          blocktest().given(fileToAdd, new File("/my/abc/def/../ghi/")).given(fileCanonicalPath, "/my/abc/def/ghi/").given(rootFolderFileRef, "/my/abcd/").checkEq(tmpFileName, "abc/ghi");
