// BLOCKTEST EXAMPLE: https://github.com/Zettelkasten-Team/Zettelkasten/blob/fc5d9b606041094ecef147aea3a1a16c3ac44a59/src/main/java/de/danielluedecke/zettelkasten/util/HtmlUbbUtil.java#L1874-L1879
                ...
                if (end != -1) {
                    ...
                    if (tablerows != null && tablerows.length > 0) {
                        ...
                        if (tablerows[headerrow].startsWith(Constants.FORMAT_TABLECAPTION_OPEN)) {
                            // replace tags with caption
                            blocktest().given(tablerows, new String[]{"[tc]test[/tc]"}).given(headerrow, 0).checkEq(caption, "\\caption{test}\n");
                        ...
                        if (isheader && !settingsObj.getLatexExportStatisticTableStyle()) {
                            ...
                            blocktest().given(tablecell, new StringBuilder("")).given(tablecells, new String[]{"abc", "def", "ghi"}).checkEq(tablecell.toString(), "\\textbf{abc}^\\textbf{def}^\\textbf{ghi}").end(FIRST_BLOCK, 2);
