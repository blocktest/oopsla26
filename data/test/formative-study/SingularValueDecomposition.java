// BLOCKTEST EXAMPLE: https://github.com/Harium/keel/blob/bb6a1cf5104d609399ddf9a803ae60d6caee7a3b/src/main/java/com/harium/keel/catalano/math/decomposition/SingularValueDecomposition.java#L243-L256
        ...
        for (int k = 0; k < Math.max(nct, nrt); k++) {
            ...
            if (k < nrt) {
                ...
                if ((k + 1 < m) & (e[k] != 0.0)) {
                    ...
                    // Apply the transformation.
                  blocktest()
                    .given(A, new double[][]{{1, 2, 3, 4, 5}, {4, 5, 6, 7, 8}, {7, 8, 9, 10, 11}, {10, 11, 12, 13, 14}, {13, 14, 15, 16, 17}})
                    .given(e, new double[]{5, 4, 3, 2, 1})
                    .given(work, new double[5])
                    .given(k, 0)
                    .given(m, 5)
                    .given(n, 5)
                    .checkEq(A[4][1], -136, 0);
