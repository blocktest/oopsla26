// BLOCKTEST EXAMPLE: https://github.com/3redronin/mu-server/blob/0ad98c9e0a8ace169d467b4285fcee00fa022150/src/main/java/io/muserver/rest/MuVariantListBuilder.java#L91-L122
...
class MuVariantListBuilder extends Variant.VariantListBuilder {
	...
	static Variant selectVariant(List<Variant> available, List<Locale.LanguageRange> preferredLanguages, List<MediaType> acceptableMediaTypes, List<ParameterizedHeaderWithValue> acceptableEncodings) {
		...
		/*
		@lambdatest()
			.given(v1, new Variant(null, "fr", null), "Variant")
			.given(v2, new Variant(null, "en", "US", null), "Variant")
			.given(preferredLanguages, Locale.LanguageRange.parse("fr, *"))
			.given(acceptableMediaTypes, emptyList())
			.given(acceptableEncodings, emptyList())
			.checkReturnEq(-1);
		*/
