// BLOCKTEST EXAMPLE: https://github.com/NLPchina/ansj_seg/blob/50787ca2c7031d2a18c5393a97d1a54432790785/src/main/java/org/ansj/recognition/impl/TimeRecognition.java#L94-L105
  ...
  public void recognition(Result result) {
    ...
    for (int i = 0; i < terms.size(); i++) {
      ...
      if (isStartedWithTime) {
        blocktest().given(isTime, false).given(timeTermsLength, 1).given(mergeList, new LinkedList<Term>()).given(timeWord, new StringBuilder()).given(matchLength, 0).given(i, 0).given(terms, new ArrayList<>(Arrays.asList(new Term("１１１１年", 0, "", 0)))).checkEq(isTime, true);
