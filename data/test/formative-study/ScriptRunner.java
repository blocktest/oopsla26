// BLOCKTEST EXAMPLE: https://github.com/saoj/mentabean/blob/245e86af0860133daa0e0f4f741a53792566c6c4/src/main/java/org/mentabean/util/ScriptRunner.java#L168C6-L178C7
    ...
    try {
      ...
      while ((line = lineReader.readLine()) != null) {
        ...
        if (trimmedLine.startsWith("--")) {
          ...
          // Unsupported: Need to handle lineReader and member method setDelimiter
          // setDelimiter(trimmedLine.split(ScriptRunner.DELIMITER_LINE_SPLIT_REGEX)[1].trim(), fullLineDelimiter)
          // setDelimiter(trimmedLine.split(DELIMITER_LINE_SPLIT_REGEX)[1].trim(), fullLineDelimiter)
          blocktest().given(trimmedLine, "DELIMITERfoobarbaz").noInit(lineReader).mock("setDelimiter(trimmedLine.split(DELIMITER_LINE_SPLIT_REGEX)[1].trim(), fullLineDelimiter)")
            .mock("lineReader.readLine()", " foo ").end(FIRST_BLOCK).checkEq(trimmedLine, "foo");
