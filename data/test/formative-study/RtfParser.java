// BLOCKTEST UNSUPPORTED EXAMPLE: https://github.com/albfernandez/itext2/blob/cc7dc8b6a18090bd0087eec92bf19a5fe2bdd0a4/src/main/java/com/lowagie/text/rtf/parser/RtfParser.java#L1207-L1222
...
//						}
          ...
          default:
            ...
            if(this.getTokeniserState() == TOKENISER_HEX) {
              // blocktest().given(pbReader, ???).given(nextChar, '!').given(this.byteCount, 0).end(FIRST_BLOCK, 2)
