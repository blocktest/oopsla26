// BLOCKTEST EXAMPLE: https://github.com/mojohaus/license-maven-plugin/blob/7d1b033e96037dcc672bcf5ac478cd8f43d4894c/src/main/java/org/codehaus/mojo/license/header/transformer/AbstractFileHeaderTransformer.java#L425C1-L435C18
    ...
    public String unboxComent( String header )
    {
        ...
        for ( String line : header.split( LINE_SEPARATOR + "" ) )
        {
            ...
            else
            {
                ...
                blocktest().given(line, "--").given(s, "--").checkEq(line, "");
//              blocktest().given(line, "--foo").given(s, "--").checkEq(line, "foo");
//              blocktest().given(line, "-").given(s, "--").checkEq(line, "");
                // Above two tests will fail due to bug https://github.com/mojohaus/license-maven-plugin/commit/3b0683e2901bbb1f4cca7adf5eb58fe514313816
