    ...
    public List<String> listCatalogs() throws ParadoxDataException {
        ...
        if (enableCatalogChange && currentCatalog.getParent() != null) {
            ...
            if (catalogFiles != null) {
                // BLOCKTEST EVAL: https://github.com/leonhad/paradoxdriver/blob/de3a6ad18b6c7f1d461383876339dc8086beaead/src/main/java/com/googlecode/paradox/ConnectionInfo.java#L505-L509
                lambdatest().args(new File(System.getProperty("user.dir"))).given(locale, DEFAULT_LOCALE).checkReturnTrue();
                lambdatest().args(new File(System.getProperty("user.dir") + "/target/generated-sources/annotations")).given(locale, DEFAULT_LOCALE).checkReturnFalse();
