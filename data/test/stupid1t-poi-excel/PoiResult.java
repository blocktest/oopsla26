        ...
        if (this.hasError()) {
            ...
            lineByError.forEach((rowNum, errorMessage) -> {
                List<String> subMessage = errorMessage.stream().map(e -> {
                    ...
                    blocktest().given(e, new ErrorMessage("a", 1, 2, new FileNotFoundException("b")))
                        .checkReturnEq("a-b");
                    blocktest().given(e, new ErrorMessage("a", 2, 0, new FileNotFoundException("b!")))
                         .checkReturnEq("a-b!");
                    blocktest().given(e, new ErrorMessage("a", -1, 2, new FileNotFoundException("bX")))
                        .checkReturnEq("bX");
                    blocktest().given(e, new ErrorMessage("a", 1, -1, new FileNotFoundException("b")))
                        .checkReturnEq("b");
                    blocktest().given(e, new ErrorMessage("a", -1, -1, new FileNotFoundException("bW")))
                        .checkReturnEq("bW");
                    int col = e.getCol();
                    int row = e.getRow();
                    String location = e.getLocation();
