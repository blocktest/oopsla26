...
import static org.blocktest.types.Flow.ElseIf;
...
public class Time {
    ...
    public static final class CronExpression implements Serializable, Cloneable {
                ...
                if (type == MONTH) {
                    ...
                    if (s.length() > i + 3) {
                        ...
                        if (c == '-') {
                            ...
                            // BLOCKTEST EVAL: https://github.com/rythmengine/rythmengine/blob/3439bd728c8e95927cea9146b5d6b59a30c3c516/src/main/java/org/rythmengine/utils/Time.java#L600C1-L610C30
                            blocktest().given(i, -3).given(s, "#1");
                            blocktest().given(i, -3).given(s, "#5");
                            blocktest().given(i, -3).given(s, "#0").expect(Exception.class);
                            blocktest().given(i, -3).given(s, "#6").expect(Exception.class);
                            blocktest().given(i, -3).given(s, "#a").expect(ParseException.class);
                            blocktest().given(i, -4).given(s, "#1").expect(ParseException.class);
                            blocktest().given(i, -2).given(s, "#1").expect(ParseException.class);
                            blocktest().given(i, -5).given(s, "#1").expect(ParseException.class);
                            blocktest().given(i, -1).given(s, "#1").expect(ParseException.class);
                            try {
                                i += 4;
        ...
        protected void addToSet(int val, int end, int incr, int type)
            ...
            // BLOCKTEST EVAL: https://github.com/rythmengine/rythmengine/blob/3439bd728c8e95927cea9146b5d6b59a30c3c516/src/main/java/org/rythmengine/utils/Time.java#L971C1-L998C14
            // Case second good
            blocktest().given(type, SECOND).given(val, 0).given(end, 59).end(FIRST_BLOCK).checkFlow(IfStmt, Then, IfStmt);
            // Case second bad
            blocktest().given(type, SECOND).given(val, -1).given(end, 59).end(FIRST_BLOCK).expect(ParseException.class);
            // Case minute good
            blocktest().given(type, MINUTE).given(val, 0).given(end, 59).end(FIRST_BLOCK).checkFlow(IfStmt, Then, IfStmt);
            // Case minute bad
            blocktest().given(type, MINUTE).given(val, -1).given(end, 59).end(FIRST_BLOCK).expect(ParseException.class);
            // Case hour good
            blocktest().given(type, HOUR).given(val, 0).given(end, 23).end(FIRST_BLOCK).checkFlow(IfStmt, ElseIf, Then, IfStmt);
            // Case hour bad
            blocktest().given(type, HOUR).given(val, 0).given(end, 59).end(FIRST_BLOCK).expect(ParseException.class);
            // Case day of month good
            blocktest().given(type, DAY_OF_MONTH).given(val, 1).given(end, 31).end(FIRST_BLOCK).checkFlow(IfStmt, ElseIf, ElseIf, Then, IfStmt);
            // Case day of month bad
            blocktest().given(type, DAY_OF_MONTH).given(val, 0).given(end, 31).end(FIRST_BLOCK).expect(ParseException.class);
            // Case month good
            blocktest().given(type, MONTH).given(val, 1).given(end, 12).end(FIRST_BLOCK).checkFlow(IfStmt, ElseIf, ElseIf, ElseIf, Then, IfStmt);
            // Case month bad
            blocktest().given(type, MONTH).given(val, 0).given(end, 12).end(FIRST_BLOCK).expect(ParseException.class);
            // Case day of week good
            blocktest().given(type, DAY_OF_WEEK).given(val, 1).given(end, 7).end(FIRST_BLOCK).checkFlow(IfStmt, ElseIf, ElseIf, ElseIf, ElseIf, Then, IfStmt);
            // Case day of week bad
            blocktest().given(type, DAY_OF_WEEK).given(val, 0).given(end, 7).end(FIRST_BLOCK).expect(ParseException.class);
            ...
            if (type == SECOND || type == MINUTE) {
                // BLOCKTEST EVAL: https://github.com/rythmengine/rythmengine/blob/3439bd728c8e95927cea9146b5d6b59a30c3c516/src/main/java/org/rythmengine/utils/Time.java#L1019-L1024
                blocktest().given(stopAt, -1).given(startAt, 1).checkEq(stopAt, 59).checkEq(startAt, 1);
                blocktest().given(stopAt, 2).given(startAt, -1).checkEq(stopAt, 2).checkEq(startAt, 0);
                blocktest().given(stopAt, 2).given(startAt, 99).checkEq(stopAt, 2).checkEq(startAt, 0);
                blocktest().given(stopAt, -1).given(startAt, 99).checkEq(stopAt, 59).checkEq(startAt, 0);
                if (stopAt == -1) {
                    stopAt = 59;
                }
                ...
                // BLOCKTEST EVAL: https://github.com/rythmengine/rythmengine/blob/3439bd728c8e95927cea9146b5d6b59a30c3c516/src/main/java/org/rythmengine/utils/Time.java#L1026-L1031
                blocktest().given(stopAt, -1).given(startAt, 1).checkEq(stopAt, 23).checkEq(startAt, 1);
                blocktest().given(stopAt, 2).given(startAt, -1).checkEq(stopAt, 2).checkEq(startAt, 0);
                blocktest().given(stopAt, 2).given(startAt, 99).checkEq(stopAt, 2).checkEq(startAt, 0);
                blocktest().given(stopAt, -1).given(startAt, 99).checkEq(stopAt, 23).checkEq(startAt, 0);
                if (stopAt == -1) {
                    stopAt = 23;
                }
                if (startAt == -1 || startAt == ALL_SPEC_INT) {
                ...
                // BLOCKTEST EVAL: https://github.com/rythmengine/rythmengine/blob/3439bd728c8e95927cea9146b5d6b59a30c3c516/src/main/java/org/rythmengine/utils/Time.java#L1033-L1038
                blocktest().given(stopAt, -1).given(startAt, 2).checkEq(stopAt, 31).checkEq(startAt, 2);
                blocktest().given(stopAt, 2).given(startAt, -1).checkEq(stopAt, 2).checkEq(startAt, 1);
                blocktest().given(stopAt, 2).given(startAt, 99).checkEq(stopAt, 2).checkEq(startAt, 1);
                blocktest().given(stopAt, -1).given(startAt, 99).checkEq(stopAt, 31).checkEq(startAt, 1);
                if (stopAt == -1) {
                    stopAt = 31;
                }
                if (startAt == -1 || startAt == ALL_SPEC_INT) {
