...
private int jjMoveNfa_4(int startState, int curPos)
{
   ...
   for (;;)
   {
      ...
      else
      {
         ...
         int i2 = (curChar & 0xff) >> 6;
         long l2 = 1L << (curChar & 077);
          // BLOCKTEST EVAL: https://github.com/pfmiles/min-velocity/blob/4e8ec4f64681c1d6941bf8d90a51849e87b86cf5/src/main/java/com/github/pfmiles/org/apache/velocity/runtime/parser/ParserTokenManager.java#L4456C1-L4460C42
          blocktest().given(curChar, 'D').checkEq(i1, 0).checkEq((int)l1, 1).checkEq(i2, 1).checkEq((int)l2, 16).start(FIRST_BLOCK);
         do
         {
            switch(jjstateSet[--i])
            {
