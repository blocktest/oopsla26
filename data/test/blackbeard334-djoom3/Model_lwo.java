            ...
            while (true) {
                ...
                switch (id) {
                    ...
                    case ID_FLAG:
                        ...
                        // BLOCKTEST EVAL: https://github.com/blackbeard334/djoom3/blob/64362645420c99ac621b051a678de96883e2a329/src/main/java/neo/Renderer/Model_lwo.java#L2980C1-L2997C26
                        // All on
                        blocktest().given(flags, 1023).given(surf, new lwSurface()).start(FIRST_BLOCK, 6)
                                .checkEq(surf.smooth, 1.56207f, Double.MIN_VALUE)
                                .checkEq(surf.color_hilite.val, 1.0f, Double.MIN_VALUE)
                                .checkEq(surf.dif_sharp.val, 0.5f, Double.MIN_VALUE)
                                .checkEq(surf.sideflags, 3)
                                .checkEq(surf.add_trans.val, 1.0f, Double.MIN_VALUE);
                        // All off
                        blocktest().given(flags, 0).given(surf, new lwSurface()).start(FIRST_BLOCK, 6)
                                .checkFalse(surf.smooth == 1.56207f)
                                .checkFalse(surf.color_hilite.val == 1.0f)
                                .checkFalse(surf.dif_sharp.val == 0.5f)
                                .checkFalse(surf.sideflags == 3)
                                .checkFalse(surf.add_trans.val == 1.0f);
                        break;
