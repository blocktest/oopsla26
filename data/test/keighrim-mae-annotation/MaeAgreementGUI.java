    ...
    private JComponent prepareAnnotatorSelectionPanel(List<String> annotatorIDs) {
        ...
        for (int i = 0; i < annotatorIDs.size(); i++) {
            ...
            annotatorCheckBox.addItemListener(e -> {
                ...
                // @blocktest().given(annotatorID, "foo").given(calc, new MaeAgreementMain(new LocalSqliteDriverImpl(MaeStrings.newTempTestDBFile()))).given(e, new ItemEvent(new java.awt.List(), 5, "String", 2)).expect(NullPointerException.class);
