                ...
                while (offset < plainText.length()) {
                    ...
                    if (Character.isHighSurrogate(c)) {
                        ...
                        Thread thread = new Thread(() -> {
                            // BLOCKTEST EVAL: https://github.com/keighrim/mae-annotation/blob/a4bf15aaad14f80b4c6a076bd01c58f6e4d07000/src/main/java/edu/brandeis/llc/mae/util/FontHandler.java#L128-L134
                            // @blocktest().given(document, new DefaultStyledDocument()).given(finalLength, 1).given(plainText, "\uD83C\uDF09").given(finalOffset, 1).checkEq(unicodeASet.toString(), "family=Dialog.plain ");
