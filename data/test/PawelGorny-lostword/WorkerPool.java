    ...
    private void checkUnknown(int position) throws InterruptedException {
        ...
        for (int w0=0; RESULT==null && w0<DIC_SIZE; w0++){
            ...
            for (int t = 0; t < THREADS; t++) {
                ...
                // BLOCKTEST EVAL: https://github.com/PawelGorny/lostword/blob/8e66ab8737a5119a21cef6c948ae7b48f00fdb91/src/main/java/com/pawelgorny/lostword/WorkerPool.java#L76-L92
                /*
