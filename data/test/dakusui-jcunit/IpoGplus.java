        ...
        if (ts.stream().anyMatch(σ::isSubtupleOf)) {
          ...
          Tuple chosenTest = streamIncompleteTestsToCoverGivenTuple(
              ...
              (Tuple tuple) -> isAllowedTuple(allFactors, allConstraints, this.session).test(
                      // BLOCKTEST EVAL: https://github.com/dakusui/jcunit/blob/5e081ae71f7e1ab8326aed77612a97c983c9dc06/src/main/java/com/github/dakusui/jcunit8/pipeline/stages/generators/IpoGplus.java#L200-L202
