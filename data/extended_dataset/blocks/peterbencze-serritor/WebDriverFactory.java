    ...
    private static ChromeDriver createChromeDriver(final Capabilities capabilities) {
        ...
        if (capability instanceof Map) {
            ...
            extraOptions.forEach((key, value) -> {
                ...
                blocktest().given(key, "binary", "String").given(value, "/path", "Object")
                    .given(extraOptions, new java.util.HashMap<String, Object>(){{put("binary", "/path");}}, "Map<String, Object>")
                    .checkEq(options.asMap().toString(), "{browserName=chrome, goog:chromeOptions={args=[], binary=/path, extensions=[]}}");
                
                blocktest().given(key, "args", "String").given(value, new java.util.ArrayList<>(java.util.Arrays.asList("1", "2")), "Object")
                    .given(extraOptions, new java.util.HashMap<String, Object>(), "Map<String, Object>")
                    .checkEq(options.asMap().toString(), "{browserName=chrome, goog:chromeOptions={args=[1, 2], extensions=[]}}");
                
                blocktest().given(key, "extensions", "String").given(value, new java.util.ArrayList<>(java.util.Arrays.asList("1", "2")), "Object")
                    .given(extraOptions, new java.util.HashMap<String, Object>(), "Map<String, Object>")
                    .checkEq(options.asMap().toString(), "{browserName=chrome, goog:chromeOptions={args=[], extensions=[1, 2]}}");
                
               blocktest().given(key, "foo", "String").given(value, "bar", "Object")
                    .given(extraOptions, new java.util.HashMap<String, Object>(), "Map<String, Object>")
