    ...
    public void hook(HttpServletRequest request, HttpServletResponse response, FilterHookChain chain) throws IOException, ServletException {
        ...
        if (originallyMap != null) {
            mdcMap.forEach((key, value) -> {
                // BLOCKTEST EVAL: https://github.com/lastaflute/lastaflute/blob/01201e2eee995053bf6f9febcf58ace01ed38c30/src/main/java/org/lastaflute/web/servlet/filter/mdc/MDCHook.java#L94-L99
                blocktest().given(originallyMap, new HashMap<String, String>()).given(MDC.get(key), "value", "String")
                        .given(key, "key", "String")
                        .checkEq(originallyMap.get("key"), "value");
