...
public class GodHandableAction implements VirtualAction {
    ...
    protected ActionResponse handleValidationErrorException(ValidationErrorException cause) {
        ...
        if (logger.isDebugEnabled()) {
            ...
            // BLOCKTEST EVAL: https://github.com/lastaflute/lastaflute/blob/01201e2eee995053bf6f9febcf58ace01ed38c30/src/main/java/org/lastaflute/web/ruts/GodHandableAction.java#L417-L422
            messages.toPropertySet().forEach(property -> {
                blocktest().given(sb, new StringBuilder()).given(LF, "\n", "String").given(property, "property", "String")
                        .given(messages, new UserMessages())
                        .checkEq(sb.toString(), "\n property");
