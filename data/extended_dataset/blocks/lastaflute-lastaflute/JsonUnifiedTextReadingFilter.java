        ...
        if (simple != null || typeable != null) {
            return (adaptingType, text) -> {
                ...
                blocktest().given(simple, (JsonSimpleTextReadingFilter) text1 -> text1.substring(2))
                        ...
                        .given(adaptingType, String.class, "Class<String>").given(text, "ABCDEFGH", "String").checkReturnEq("GH");

                blocktest().given(simple, (JsonSimpleTextReadingFilter) text1 -> text1.substring(2))
                        .given(typeable, (JsonTypeableTextReadingFilter) (type, text1) -> type.getName().contains("String") ? text1.substring(1) : text1.substring(4))
                        .given(adaptingType, String.class, "Class<String>").given(text, "ABCDEFGH", "String").checkReturnEq("DEFGH");

                blocktest().given(simple, (JsonSimpleTextReadingFilter) text1 -> text1.substring(2))
                        .given(typeable, (JsonTypeableTextReadingFilter) (type, text1) -> type.getName().contains("String") ? text1.substring(1) : text1.substring(4))
                        .given(adaptingType, Integer.class, "Class<Integer>").given(text, "ABCDEFGH", "String").checkReturnEq("GH");

                blocktest().given(simple, (JsonSimpleTextReadingFilter) text1 -> text1.substring(2))
                        .given(typeable, null)
                        .given(adaptingType, String.class, "Class<String>").given(text, "ABCDEFGH", "String").checkReturnEq("CDEFGH");

                blocktest().given(simple, null)
                        .given(typeable, (JsonTypeableTextReadingFilter) (type, text1) -> text1.substring(4))
                        .given(adaptingType, String.class, "Class<String>").given(text, "ABCDEFGH", "String").checkReturnEq("EFGH");
