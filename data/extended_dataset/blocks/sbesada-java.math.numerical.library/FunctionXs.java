// TEST_DIR: src/test/java/com/mathLibrary/function
                ...
                if (isValidCharacter(character)) {
                    ...
                    if (i == (f.length() - 1)) {
                        ...
                        if (function.equals(E)) {
                            ...
                            // BLOCKTEST EVAL: https://github.com/sbesada/java.math.numerical.library/blob/a2f18eda6de69c937183771d3b1f268e606a8871/src/main/java/com/mathlibrary/function/FunctionXs.java#L414C29-L425C30
                            blocktest().given(function, "fx").given(variables, java.util.Arrays.asList("x", "z", "t", "fx"))
                                .given(values, java.util.Arrays.asList(1.0, 2.0, 3.0, 4.0)).expect(CalculatorException.class);
                            blocktest().given(function, "t").given(variables, java.util.Arrays.asList("x", "z", "t", "fx"))
                                .given(values, java.util.Arrays.asList(1.0, 2.0, 3.0, 4.0)).checkEq(value, 3.0, 0.001);
                            blocktest().given(function, "t").given(variables, java.util.Arrays.asList("x", "z", "m", "fx"))
                                .given(values, java.util.Arrays.asList(1.0, 2.0, 3.0, 4.0)).expect(CalculatorException.class);
                            blocktest().given(function, "").given(variables, java.util.Arrays.asList("x", "z", "m", "fx"))
                                .given(values, java.util.Arrays.asList(1.0, 2.0, 3.0, 4.0)).expect(CalculatorException.class);
