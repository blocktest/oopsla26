  ...
  private SurefireBooter constructSurefireBooter() throws MojoExecutionException, MojoFailureException {
    ...
    if (this.suiteXmlFiles != null && this.suiteXmlFiles.length > 0 && this.test == null) {
      ...
      if (this.test != null) {
        ...
        // BLOCKTEST EVAL: https://github.com/maven-nar/nar-maven-plugin/blob/e747b5ee080b243e0b817f722a43c9c203bb4df8/src/main/java/com/github/maven_nar/NarIntegrationTestMojo.java#L707C1-L718C10
          blocktest().given(this.test, "foo.Bar.java,bar.Baz.java").given(includeList, new ArrayList<String>()).checkEq(includeList.get(0), "**/foo/Bar.java");
    ...
    if (fork.isForking()) {
      ...
      if (this.argLine != null) {
        // BLOCKTEST EVAL: https://github.com/maven-nar/nar-maven-plugin/blob/e747b5ee080b243e0b817f722a43c9c203bb4df8/src/main/java/com/github/maven_nar/NarIntegrationTestMojo.java#L952C1-L955C10
        // Case if with only clause 1
        blocktest().given(this.argLine, "-da -Xmx512m").given(this.enableAssertions, true).checkEq(this.enableAssertions, false);
        // Case if with only clause 2
        blocktest().given(this.argLine, "-disableassertions -Xmx512m").given(this.enableAssertions, true).checkEq(this.enableAssertions, false);
        // Case with both clauses
        blocktest().given(this.argLine, "-da -disableassertions -Xmx512m").given(this.enableAssertions, true).checkEq(this.enableAssertions, false);
        // Case with none of the clauses
        blocktest().given(this.argLine, "-Xmx512m").given(this.enableAssertions, true).checkEq(this.enableAssertions, true);
