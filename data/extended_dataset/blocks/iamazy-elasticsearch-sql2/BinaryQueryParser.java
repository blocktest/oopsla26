    ...
    public AtomicQuery parseBinaryQuery(SQLBinaryOpExpr binQueryExpr, String queryAs) {
        ...
        if (SQLBinaryOperator.Equality == binaryOperator || SQLBinaryOperator.LessThanOrGreater == binaryOperator || SQLBinaryOperator.NotEqual == binaryOperator) {
            ...
            return parseCondition(binQueryExpr.getLeft(), operator, new Object[]{targetVal}, queryAs, (queryFieldName, operator1, rightParamValues) -> {
                ...
                blocktest().given(queryFieldName, "foo", "String").given(rightParamValues, new Object[]{"1"}, "Object[]").given(operator1, SqlConditionOperator.Equality, "SqlConditionOperator")
                        .checkEq(methodReturn.toString(), "{\n" +
                                ...
                                "  }\n" +
                                "}");
                blocktest().given(queryFieldName, "bar", "String").given(rightParamValues, new Object[]{"12"}, "Object[]").given(operator1, SqlConditionOperator.IsNull, "SqlConditionOperator")
                        .checkEq(methodReturn.toString(), "{\n" +
                                "  \"bool\" : {\n" +
                                "    \"must_not\" : [\n" +
                                "      {\n" +
        ...
        if (SQLBinaryOperator.Is == binaryOperator || SQLBinaryOperator.IsNot == binaryOperator) {
            ...
            return parseCondition(binQueryExpr.getLeft(), operator, null, queryAs, (queryFieldName, operator13, rightParamValues) -> {
                ...
                blocktest().given(queryFieldName, "foo", "String").given(operator13, SqlConditionOperator.IsNull, "SqlConditionOperator").checkEq(methodReturn.toString(), "{\n" +
                        "  \"bool\" : {\n" +
                        "    \"must_not\" : [\n" +
                        "      {\n" +
                        "        \"exists\" : {\n" +
                        ...
                        "  }\n" +
                        "}");
                blocktest().given(queryFieldName, "foo", "String").given(operator13, SqlConditionOperator.IsNotNull, "SqlConditionOperator").checkEq(methodReturn.toString(), "{\n" +
                        "  \"exists\" : {\n" +
                        "    \"field\" : \"foo\",\n" +
                        "    \"boost\" : 1.0\n" +
                        "  }\n" +
