...
import org.apache.curator.framework.recipes.cache.ChildData;import org.apache.zookeeper.data.Stat;import org.blocktest.BTest;
            ...
            if (TreeCacheEvent.Type.NODE_UPDATED.equals(event.getType())
                ...
                requestTreeCache.getCurrentChildren(securityPath).entrySet().stream().forEach(requestEntry -> {
                    ...
                    requestTreeCache.getCurrentChildren(filterPath).entrySet().stream().forEach(itemEntry -> {
                        ...
                        blocktest().given(itemEntry, new HashMap<String, ChildData>(){{ put("a", new ChildData("/tmp/path", new Stat(), "{\"isStart\":true}".getBytes())); }}.entrySet().iterator().next(), "HashMap.Entry<String, ChildData>")
                        ...
                        blocktest().given(itemEntry, new HashMap<String, ChildData>(){{ put("b", new ChildData("/tmp/path", new Stat(), "{\"isStart\":false}".getBytes())); }}.entrySet().iterator().next(), "HashMap.Entry<String, ChildData>")
            ...
            if (TreeCacheEvent.Type.NODE_UPDATED.equals(event.getType())
                ...
                upstreamTreeCache.getCurrentChildren(upstreamPath).entrySet().stream().forEach(hostEntry -> {
                    ...
                    upstreamTreeCache.getCurrentChildren(hostPath).entrySet().stream().forEach(serverEntry -> {
                        ...
                        blocktest().given(serverEntry, new HashMap<String, ChildData>(){{ put("1.2.3.4:80", new ChildData("/tmp/path", new Stat(), "{\"weight\":50}".getBytes())); }}.entrySet().iterator().next(), "HashMap.Entry<String, ChildData>")
                        ...
                        blocktest().given(serverEntry, new HashMap<String, ChildData>(){{ put("1.2.3.5:22", new ChildData("/tmp/path", new Stat(), "{\"isStart\":false}".getBytes())); }}.entrySet().iterator().next(), "HashMap.Entry<String, ChildData>")
        ...
        rewriteTreeCache.getListenable().addListener((client, event) -> {
            if (TreeCacheEvent.Type.NODE_UPDATED.equals(event.getType())
                ...
                rewriteTreeCache.getCurrentChildren(rewritePath).entrySet().stream().forEach(hostEntry -> {
                    ...
                    blocktest().given(hostEntry, new HashMap<String, ChildData>(){{ put("a", new ChildData("/tmp/path", new Stat(), "{\"isStart\":true}".getBytes())); }}.entrySet().iterator().next(), "HashMap.Entry<String, ChildData>")
                            .checkEq(rewriteConfigrMap.size(), 1).checkEq(wafRoutes.size(), 1);
                    blocktest().given(hostEntry, new HashMap<String, ChildData>(){{ put("b", new ChildData("/tmp/path", new Stat(), "{\"isStart\":true}".getBytes())); }}.entrySet().iterator().next(), "HashMap.Entry<String, ChildData>")
