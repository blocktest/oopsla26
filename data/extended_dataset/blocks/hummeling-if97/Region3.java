...
final class Region3 extends Region {
    ...
    double isentropicExponentRhoT(double density, double temperature) {
    ...
    double specificVolumePT(double p, double T) {
        ...
        switch (subRegion) {
            case n:
                // BLOCKTEST EVAL: https://github.com/hummeling/if97/blob/a508c11bea77ebc39d6bf8c7b21854947e07ca96/src/main/java/com/hummeling/if97/Region3.java#L1201C1-L1206C53
                blocktest().given(pi, Math.PI).given(theta, 0.5).given(omega, 0).given(subRegion, SubRegion.x)
                        .end(FIRST_BLOCK, 3).checkReturnEq(Double.POSITIVE_INFINITY, Double.MIN_VALUE);
            ...
            default:
                // BLOCKTEST EVAL: https://github.com/hummeling/if97/blob/a508c11bea77ebc39d6bf8c7b21854947e07ca96/src/main/java/com/hummeling/if97/Region3.java#L1209C1-L1216C66
                blocktest().given(pi, Math.PI).given(theta, 0.5).given(omega, 0).given(subRegion, SubRegion.x)
                        .end(FIRST_BLOCK, 3).checkReturnEq(2.5436585071070736E22, Double.MIN_VALUE);
                x = new double[]{
