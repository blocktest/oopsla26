...
public class MPPTaskField
{
   ...
   public static FieldType getInstance(ProjectFile project, int value)
   {
      if ((value & 0x8000) != 0)
      {
         // BLOCKTEST EVAL: https://github.com/joniles/mpxj/blob/91540932b1db27a525f1ee9e9fb9d878acedfc74/src/main/java/net/sf/mpxj/common/MPPTaskField.java#L54-L59
         return project.getUserDefinedFields().getOrCreateTaskField(Integer.valueOf(value), (k) -> {
            blocktest().given(k, 0xFFF, "Integer")
               .checkTrue(methodReturn.toString().equals(new UserDefinedField(0xFFF, "ENTERPRISE_CUSTOM_FIELD4096",
                  "Enterprise Custom Field 4096", FieldTypeClass.TASK, false, DataType.CUSTOM).toString()));
