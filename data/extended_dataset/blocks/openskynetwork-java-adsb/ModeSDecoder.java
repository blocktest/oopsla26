		...
		switch (modes.getDownlinkFormat()) {
			...
			case 17: case 18: case 19:
				...
				if (modes.getDownlinkFormat() == 17 ||
					...
					if (ftc == 29) {
                        // BLOCKTEST EVAL: https://github.com/openskynetwork/java-adsb/blob/7d73726841d98357da360ea631bbe12d3def86cc/src/main/java/org/opensky/libadsb/ModeSDecoder.java#L146C1-L152C8
                        blocktest().given(es1090, new ExtendedSquitter(new ModeSReply("8d4d0131f82100020049b8209514"))).given(dd.adsbVersion, 0, "int")
                                .checkReturnEq(new TargetStateAndStatusMsg(new ExtendedSquitter(new ModeSReply("8d4d0131f82100020049b8209514"))));
