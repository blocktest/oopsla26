                ...
                if (root.isPortmanteau()) {
                    if (root.isPortmanteauFacedVowelEllipsis()){
                        ...
                        if (root.isPortmanteauFacedSoftening()){
                            currentFsmParse = new FsmParse(root, finiteStateMachine.getState("NominalRootNoPossesive"));
                            fsmParse.add(currentFsmParse);
                            // BLOCKTEST EVAL: https://github.com/StarlangSoftware/TurkishMorphologicalAnalysis/blob/26450b47db92b64580a2bfa4a0d7d0bce38edd49/src/main/java/MorphologicalAnalysis/FsmMorphologicalAnalyzer.java#L419C1-L434C30
                            blocktest().given(root, new TxtWord("Aabc", "CL_ISIM")).given(finiteStateMachine, new FiniteStateMachine("turkish_finite_state_machine.xml")).checkEq(currentFsmParse.toString(), "Aap+NOUN");
                            blocktest().given(root, new TxtWord("Aabcd", "CL_ISIM")).given(finiteStateMachine, new FiniteStateMachine("turkish_finite_state_machine.xml")).checkEq(currentFsmParse.toString(), "Aabç+NOUN");
                            blocktest().given(root, new TxtWord("Aabcde", "CL_ISIM")).given(finiteStateMachine, new FiniteStateMachine("turkish_finite_state_machine.xml")).checkEq(currentFsmParse.toString(), "Aabct+NOUN");
                            blocktest().given(root, new TxtWord("Aabcğd", "CL_ISIM")).given(finiteStateMachine, new FiniteStateMachine("turkish_finite_state_machine.xml")).checkEq(currentFsmParse.toString(), "Aabck+NOUN");
                            blocktest().given(root, new TxtWord("Aabcdxx", "CL_ISIM")).given(finiteStateMachine, new FiniteStateMachine("turkish_finite_state_machine.xml")).checkEq(currentFsmParse.toString(), "Aabcdx+NOUN");
                    ...
                    if (root.isVerb() || root.isPassive()) {
                        // BLOCKTEST EVAL: https://github.com/StarlangSoftware/TurkishMorphologicalAnalysis/blob/26450b47db92b64580a2bfa4a0d7d0bce38edd49/src/main/java/MorphologicalAnalysis/FsmMorphologicalAnalyzer.java#L494C5-L502C26
                        // @blocktest("testgit").end(FIRST_ASSIGN).given(root, new TxtWord("git", "FIIL")).given(finiteStateMachine, new FiniteStateMachine("turkish_finite_state_machine.xml")).checkEq(currentFsmParse.toString(), "git+VERB").checkFlow(IfStmt().Else().IfStmt().Then());
                        // @blocktest("testFoo").end(FIRST_ASSIGN).given(root, new TxtWord("foo", "PASSIVE-HN")).given(finiteStateMachine, new FiniteStateMachine("turkish_finite_state_machine.xml")).checkEq(currentFsmParse.toString(), "foo+VERB").checkFlow(IfStmt().Else().IfStmt().Else());
                        // @blocktest("testTest").end(FIRST_ASSIGN).given(root, new TxtWord("TEST", "F2P1-NO-REF")).given(finiteStateMachine, new FiniteStateMachine("turkish_finite_state_machine.xml")).checkEq(currentFsmParse.toString(), "TEST+VERB").checkFlow(IfStmt().Then());
