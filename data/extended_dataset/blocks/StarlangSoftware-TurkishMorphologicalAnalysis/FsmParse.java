                                                                                            ...
                                                                                            if (suffixList.get(0).getName().equalsIgnoreCase("QuestionRoot")) {
                                                                                                ...
                                                                                                if (suffixList.get(0).getName().equalsIgnoreCase("PostP")) {
                                                                                                    if (formList.get(0).equalsIgnoreCase("karşı") || formList.get(0).equalsIgnoreCase("ilişkin") || formList.get(0).equalsIgnoreCase("göre") || formList.get(0).equalsIgnoreCase("kadar") || formList.get(0).equalsIgnoreCase("ait") || formList.get(0).equalsIgnoreCase("yönelik") || formList.get(0).equalsIgnoreCase("rağmen") || formList.get(0).equalsIgnoreCase("değin") || formList.get(0).equalsIgnoreCase("dek") || formList.get(0).equalsIgnoreCase("doğru") || formList.get(0).equalsIgnoreCase("karşın") || formList.get(0).equalsIgnoreCase("dair") || formList.get(0).equalsIgnoreCase("atfen") || formList.get(0).equalsIgnoreCase("binaen") || formList.get(0).equalsIgnoreCase("hitaben") || formList.get(0).equalsIgnoreCase("istinaden") || formList.get(0).equalsIgnoreCase("mahsuben") || formList.get(0).equalsIgnoreCase("mukabil") || formList.get(0).equalsIgnoreCase("nazaran")) {
                                                                                                        ...
                                                                                                        if (formList.get(0).equalsIgnoreCase("sonra") || formList.get(0).equalsIgnoreCase("önce") || formList.get(0).equalsIgnoreCase("beri") || formList.get(0).equalsIgnoreCase("fazla") || formList.get(0).equalsIgnoreCase("dolayı") || formList.get(0).equalsIgnoreCase("itibaren") || formList.get(0).equalsIgnoreCase("başka") || formList.get(0).equalsIgnoreCase("çok") || formList.get(0).equalsIgnoreCase("evvel") || formList.get(0).equalsIgnoreCase("ötürü") || formList.get(0).equalsIgnoreCase("yana") || formList.get(0).equalsIgnoreCase("öte") || formList.get(0).equalsIgnoreCase("aşağı") || formList.get(0).equalsIgnoreCase("yukarı") || formList.get(0).equalsIgnoreCase("dışarı") || formList.get(0).equalsIgnoreCase("az") || formList.get(0).equalsIgnoreCase("gayrı")) {
                                                                                                            ...
                                                                                                            if (formList.get(0).equalsIgnoreCase("yanısıra")) {
                                                                                                                ...
                                                                                                                // BLOCKTEST EVAL: https://github.com/StarlangSoftware/TurkishMorphologicalAnalysis/blob/26450b47db92b64580a2bfa4a0d7d0bce38edd49/src/main/java/MorphologicalAnalysis/FsmParse.java#L615C1-L623C114
                                                                                                                // Case if with first clause satisfied
                                                                                                                blocktest().given(this.formList, new ArrayList<>(Collections.singletonList("birlikte"))).noInit(result).checkEq(result, "birlikte+POSTP+PCINS").start(FIRST_BLOCK);
                                                                                                                // Case if with second clause satisfied
                                                                                                                blocktest().given(this.formList, new ArrayList<>(Collections.singletonList("beraber"))).noInit(result).checkEq(result, "beraber+POSTP+PCINS").start(FIRST_BLOCK);
                                                                                                                // Case if-else-if clause 1
                                                                                                                blocktest().given(this.formList, new ArrayList<>(Collections.singletonList("aşkın"))).noInit(result).checkEq(result, "aşkın+POSTP+PCACC").start(FIRST_BLOCK);
                                                                                                                // Case if-else-if clause 2
                                                                                                                blocktest().given(this.formList, new ArrayList<>(Collections.singletonList("takiben"))).noInit(result).checkEq(result, "takiben+POSTP+PCACC").start(FIRST_BLOCK);
                                                                                                                // Case if-else-if-else
                                                                                                                blocktest().given(this.formList, new ArrayList<>(Collections.singletonList("foo"))).noInit(result).checkEq(result, "foo+POSTP+PCNOM").start(FIRST_BLOCK);
                                                                                                            }
                                                                                                        }
                                                                                                    }
                                                                                                } else {
                                                                                                    if (suffixList.get(0).getName().startsWith("PronounRoot")) {
                                                                                                        ...
                                                                                                        // BLOCKTEST EVAL: https://github.com/StarlangSoftware/TurkishMorphologicalAnalysis/blob/26450b47db92b64580a2bfa4a0d7d0bce38edd49/src/main/java/MorphologicalAnalysis/FsmParse.java#L631C102-L637C106
                                                                                                        // Case for if-then
                                                                                                        blocktest().given(this.suffixList, new ArrayList<>(Arrays.asList(new State("OrdinalRoot", true, true))))
                                                                                                                .given(this.formList, new ArrayList<>(Arrays.asList("foo"))).noInit(result)
                                                                                                                .checkEq(result, "foo+NUM+ORD").start(FIRST_BLOCK);
                                                                                                        // Case for if-else
                                                                                                        blocktest().given(this.suffixList, new ArrayList<>(Arrays.asList(new State("bar", true, true))))
                                                                                                                .given(this.formList, new ArrayList<>(Arrays.asList("bar"))).noInit(result)
                                                                                                                .checkEq(result, null).start(FIRST_BLOCK);
                                                                                                        // Case for if-else-if-then
                                                                                                        blocktest().given(this.suffixList, new ArrayList<>(Arrays.asList(new State("AdjectiveBlahblah", true, true))))
                                                                                                                .given(this.formList, new ArrayList<>(Arrays.asList("baz"))).noInit(result)
                                                                                                                .checkEq(result, "baz+ADJ").start(FIRST_BLOCK);
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                        }
