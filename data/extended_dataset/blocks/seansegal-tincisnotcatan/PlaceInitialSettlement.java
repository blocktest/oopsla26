      ...
      _ref.getBoard()
          ...
          .forEach(
              (tile) -> {
                ...
                blocktest().given(tile, new Tile(0, new HexCoordinate(0, 0, 0), new HashMap<IntersectionCoordinate, Intersection>(),  new HashMap<PathCoordinate, Path>(), TileType.ORE), "Tile")
                ...
                blocktest().given(tile, new Tile(0, new HexCoordinate(0, 9, 0), new HashMap<IntersectionCoordinate, Intersection>(),  new HashMap<PathCoordinate, Path>(), TileType.ORE), "Tile")
                        .given(coord1, new HexCoordinate(0, 0, 0)).given(coord2, new HexCoordinate(10, 0, 0)).given(coord3, new HexCoordinate(20, 0, 0))
                        .given(resToAdd, new ArrayList<Resource>())
                        .checkTrue(resToAdd.isEmpty());
                blocktest().given(tile, new Tile(0, new HexCoordinate(0, 0, 0), new HashMap<IntersectionCoordinate, Intersection>(),  new HashMap<PathCoordinate, Path>(), TileType.DESERT), "Tile")
                        .given(coord1, new HexCoordinate(0, 0, 0)).given(coord2, new HexCoordinate(10, 0, 0)).given(coord3, new HexCoordinate(20, 0, 0))
                        .given(resToAdd, new ArrayList<Resource>())
                        .checkTrue(resToAdd.isEmpty());
                blocktest().given(tile, new Tile(0, new HexCoordinate(20, 0, 0), new HashMap<IntersectionCoordinate, Intersection>(),  new HashMap<PathCoordinate, Path>(), TileType.ORE), "Tile")
                        .given(coord1, new HexCoordinate(0, 10, 0)).given(coord2, new HexCoordinate(10, 0, 0)).given(coord3, new HexCoordinate(20, 0, 0))
                        .given(resToAdd, new ArrayList<Resource>())
                        .checkEq(resToAdd.iterator().next().toString(), "ore");
                blocktest().given(tile, new Tile(0, new HexCoordinate(10, 0, 0), new HashMap<IntersectionCoordinate, Intersection>(),  new HashMap<PathCoordinate, Path>(), TileType.ORE), "Tile")
                        .given(coord1, new HexCoordinate(0, 10, 0)).given(coord2, new HexCoordinate(10, 0, 0)).given(coord3, new HexCoordinate(20, 0, 0))
                        .given(resToAdd, new ArrayList<Resource>())
                        .checkEq(resToAdd.iterator().next().toString(), "ore");
