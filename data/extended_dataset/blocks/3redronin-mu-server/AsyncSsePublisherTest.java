                    ...
                    try {
                        ...
                        while (thrownException.get() == null) {
                            ...
                            stage.whenComplete((o, throwable) -> {
                                ...
                                blocktest().given(throwable, null, "Throwable").checkEq(thrownException.get(), null).checkEq(exceptionThrownLatch.getCount(), 1);
                                blocktest().given(throwable, new FileNotFoundException(), "Throwable").checkEq(thrownException.get().toString(), "java.io.FileNotFoundException").checkEq(exceptionThrownLatch.getCount(), 0);
                                if (throwable != null) {
