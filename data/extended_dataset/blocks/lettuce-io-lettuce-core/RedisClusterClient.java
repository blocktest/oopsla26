    ...
    protected CompletableFuture<Partitions> loadPartitionsAsync() {
        ...
        fetchPartitions(topologyRefreshSource).whenComplete((nodes, throwable) -> {
            ...
            if (useDynamicRefreshSources() && topologyRefreshSource != initialUris) {
                ...
                fetchPartitions(initialUris).whenComplete((nextNodes, nextThrowable) -> {
                    // BLOCKTEST EVAL: https://github.com/redis/lettuce/blob/761d60247159662ce1db8bc20318bc4b573bc010/src/main/java/io/lettuce/core/cluster/RedisClusterClient.java#L995-L1005
                    blocktest().given(nextNodes, null, "Partitions").given(nextThrowable, new FileNotFoundException("Simulated"), "Throwable").given(throwable, new IndexOutOfBoundsException("Another"), "Throwable")
                        .checkTrue(future.isCompletedExceptionally());
                    blocktest().given(nextNodes, null, "Partitions").given(nextThrowable, null, "Throwable").given(throwable, new IndexOutOfBoundsException("Another"), "Throwable")
        ...
        if (nodeFilter != ClusterClientOptions.DEFAULT_NODE_FILTER) {
            return future.thenApply(partitions -> {
                // BLOCKTEST EVAL: https://github.com/redis/lettuce/blob/761d60247159662ce1db8bc20318bc4b573bc010/src/main/java/io/lettuce/core/cluster/RedisClusterClient.java#L1014-L1025
                blocktest().given(nodeFilter, ClusterClientOptions.DEFAULT_NODE_FILTER)
                .given(partitions, new Partitions(), "Partitions").setup(() -> {
