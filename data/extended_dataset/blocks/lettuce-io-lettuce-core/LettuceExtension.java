...
public class LettuceExtension implements ParameterResolver, AfterAllCallback, AfterEachCallback {
    ...
    public void afterEach(ExtensionContext context) {
        ...
        if (closeables != null) {
            ...
            copy.forEach(it -> {
                // BLOCKTEST EVAL: https://github.com/redis/lettuce/blob/761d60247159662ce1db8bc20318bc4b573bc010/src/test/java/io/lettuce/test/LettuceExtension.java#L219-L229
