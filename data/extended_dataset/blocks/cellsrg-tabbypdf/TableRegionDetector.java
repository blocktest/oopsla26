        ...
        for (TableRegion region : tableRegions) {
            List<TextBlock> allBlocks =
                region.getTextLines()
                    ...
                    {
                        // BLOCKTEST EVAL: https://github.com/cellsrg/tabbypdf/blob/def8bb08e7733a9b87e593cb5363ef82581628c1/src/main/java/ru/icc/cells/tabbypdf/detection/TableRegionDetector.java#L90-L96
                        blocktest().given(textBlocks, new ArrayList<>(), "List<TextBlock>").given(textBlocks2, new ArrayList<>(), "List<TextBlock>")
                                .setup(() -> {
                                    ...
                                    textBlocks2.add(tb2);
                                }).checkEq(methodReturn.toString(), "[Rectangle(left=1.0, bottom=2.0, right=3.0, top=4.0), Rectangle(left=1.0, bottom=2.0, right=3.0, top=4.0)]");
