      ...
      if (searchPath != null) {
        searchPath =
            searchPath.stream()
                .map(
                    name -> {
                      // BLOCKTEST EVAL: https://github.com/dnsjava/dnsjava/blob/206c9e51ac18e1ed6f82beb16cb6c0ff1f83b095/src/main/java/org/xbill/DNS/lookup/LookupSession.java#L301-L307
                      // @blocktest("testA").given(name, new Name("sup"), "Name").checkEq(methodReturn.toString(), "sup.");
                      try {
