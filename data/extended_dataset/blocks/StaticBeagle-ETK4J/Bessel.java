    ...
    private static Complex[] besselZeros(int n) {
        ...
        for (int i = 0; i < n; ++i) {
            SolverResults<Complex> sr = new NewtonRaphsonComplex(
                    z -> {
                        // BLOCKTEST EVAL: https://github.com/StaticBeagle/ETK4J/blob/393c622d01b9abfcead5c9c0973b4557173502e2/src/main/java/com/wildbitsfoundry/etk4j/signals/filters/Bessel.java#L296-L301
                        blocktest().given(z, new Complex(5, 10), "Complex").given(n, 10).checkEq(methodReturn.toString(), "(45532726963875710000.0000 - 74323182754758330000.0000j)");
                        blocktest().given(z, new Complex(2, 0), "Complex").given(n, 0).checkEq(methodReturn.toString(), "(1.7725 + 0.0000j)");
