    ...
    public static Object transfer(Object value, Class<?> type) {
        ...
        if (type.equals(Short.class) || type.equals(short.class)) {
            ...
            if (value instanceof java.sql.Timestamp) {
                ...
                // BLOCKTEST EVAL: https://github.com/alibaba/compileflow/blob/e96a05224f71bf4aa3d9fb37bba85764b2fc153f/src/main/java/com/alibaba/compileflow/engine/common/util/DataType.java#L1057C1-L1065C20
                // Exceptional case
                blocktest().given(value, null).expect(RuntimeException.class);
                // Non-exceptional case
                // @blocktest().given(value, "2025-12-01 19:27:04").checkReturnEq(new java.sql.Timestamp(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse("2025-12-01 19:27:04").getTime()));
                try {
    ...
    public static Object transfer(Object value, String type) {
        ...
        if (type.equalsIgnoreCase(DATATYPE_SHORT)
            ...
            if (value instanceof java.sql.Date) {
                ...
                // BLOCKTEST EVAL: https://github.com/alibaba/compileflow/blob/e96a05224f71bf4aa3d9fb37bba85764b2fc153f/src/main/java/com/alibaba/compileflow/engine/common/util/DataType.java#L1023C1-L1033C18
                // Case exceptional
                blocktest().given(value, null).expect(RuntimeException.class);
                // Case non-exceptional
                // @blocktest("FormatConversion").given(value, "2025/12/01").checkReturnEq(new java.sql.Date(new SimpleDateFormat("yyyy-MM-dd").parse("2025-12-01").getTime()));
                try {
            ...
            if (value instanceof java.sql.Time) {
                ...
                // BLOCKTEST EVAL: https://github.com/alibaba/compileflow/blob/e96a05224f71bf4aa3d9fb37bba85764b2fc153f/src/main/java/com/alibaba/compileflow/engine/common/util/DataType.java#L1041C1-L1047C18
                // @blocktest("hms").given(value, "19:27:04").checkReturnEq(new java.sql.Time(new SimpleDateFormat("HH:mm:ss").parse("19:27:04").getTime()));
                try {
