    ...
    private JComponent prepareAnnotatorSelectionPanel(List<String> annotatorIDs) {
        ...
        for (int i = 0; i < annotatorIDs.size(); i++) {
            ...
            annotatorCheckBox.addItemListener(e -> {
                // BLOCKTEST EVAL: https://github.com/keighrim/mae-annotation/blob/a4bf15aaad14f80b4c6a076bd01c58f6e4d07000/src/main/java/edu/brandeis/llc/mae/agreement/view/MaeAgreementGUI.java#L290-L296
                // @blocktest().given(annotatorID, "foo").given(calc, new MaeAgreementMain(new LocalSqliteDriverImpl(MaeStrings.newTempTestDBFile()))).given(e, new ItemEvent(new java.awt.List(), 5, "String", 2), "ItemEvent").expect(NullPointerException.class);
