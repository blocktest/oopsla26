    ...
    private ElProperty addChangeMetadata(ElProperty diffProperty, Property left, Property right) {
        ...
        if (!leftEnums.isEmpty() && !rightEnums.isEmpty()) {
            ListDiff<String> enumDiff = ListDiff.diff(leftEnums, rightEnums, (t, enumVal) -> {
                // BLOCKTEST EVAL: https://github.com/Sayi/swagger-diff/blob/e6abc1483ec90859aeba9d9ad4e7fd0368352d47/src/main/java/com/deepoove/swagger/diff/compare/ModelDiff.java#L129-L134
                blocktest().given(enumVal, "foo", "String").given(t, new ArrayList<>(Arrays.asList("bar", "fA", "FAA", "faw", "foO", "ffo")), "ArrayList<String>").checkReturnEq("foO");
                blocktest().given(enumVal, "xoo", "String").given(t, new ArrayList<>(Arrays.asList("bar", "fA", "FAA", "faw", "foO", "ffo")), "ArrayList<String>").checkReturnEq(null);
                for (String value : t) {
